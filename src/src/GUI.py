...
class ProPlanG:
    def __init__(self):
        ...
        # Debugmenu content
        self.arrow_var = BooleanVar(self.root, False)
        debugmenu.add_checkbutton(label="Show detailed arrows", variable=self.arrow_var, command=self.handle_arrow_drawing)
